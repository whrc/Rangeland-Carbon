...
write.csv(calibration.i,paste0("./SOC/",ROI,"/",ROI,"_calibration_0_",KSSL_num,".csv"))
...
calibration.i <- cbind(calibration.i[,4],calibration.i[,3])
colnames(calibration.i)[1:2] <- c("predid","sampleids")
write.csv(calibration.i,paste0("./BD/",ROI,"/",ROI,"_calibration_0_",KSSL_num,".csv"))
...
calibration.i <- cbind(calibration.i[,4],calibration.i[,3])
colnames(calibration.i)[1:2] <- c("predid","sampleids")
write.csv(calibration.i,paste0("./SOCS/",ROI,"/",ROI,"_calibration_0_",KSSL_num,".csv"))