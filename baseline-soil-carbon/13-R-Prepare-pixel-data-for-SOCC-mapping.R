...
###############################################################
# Define parameters, sites, and import datasets
...
# Generate KSSL calibration data ID and export
...
write.csv(calibration.i,paste0("./",ROI,"_calibration_",KSSL_num,"_pred_set.csv"))
