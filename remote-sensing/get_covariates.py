...
def export_daymet(daymet_collection, bucket_name, roi_asset_path, starfm_dir, out_directory_path):
...
#daymet_collection=get_daymet(start_date, end_date, roi_asset_path, daymet_collection_path)
#export_daymet(daymet_collection, bucket_name, roi_asset_path, starfm_dir, daymet_outdir)